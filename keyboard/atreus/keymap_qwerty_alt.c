...
#define FN_LAYER_ALT   KEYMAP(SHIFT(KC_1), SHIFT(KC_2),   SHIFT(KC_LBRC), SHIFT(KC_RBRC), SHIFT(KC_BSLS),                    KC_PGUP,     KC_7,   KC_8,   KC_9, SHIFT(KC_8), \
                              ...
                              KC_FN1,      SHIFT(KC_INS), KC_LGUI,        KC_LSFT,        KC_BSPC,         KC_LCTL, KC_LALT, KC_SPC,      KC_FN0, KC_DOT, KC_0, KC_EQUAL)

#define LAYER_TWO_ALT KEYMAP(KC_INS, KC_HOME, KC_UP,   KC_END,   KC_PGUP,                   KC_UP,   KC_F7,   KC_F8,  KC_F9,  KC_F10, \
